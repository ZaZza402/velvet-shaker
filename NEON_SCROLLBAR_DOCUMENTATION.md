...
::-webkit-scrollbar-thumb {
  background: linear-gradient(
    180deg,
    #667eea 0%,
    /* Replace pink */ #764ba2 50%,
    /* Replace cyan */ #667eea 100%
  );
  box-shadow: 0 0 10px rgba(102, 126, 234, 0.8), /* Blue glow */ 0 0 20px rgba(118, 75, 162, 0.6); /* Purple glow */
  /* ... */
}
```
...
```css
/* More intense glow */
box-shadow: 0 0 20px rgba(255, 20, 147, 1), /* Increase blur radius and opacity */
    0 0 40px rgba(0, 255, 255, 1), 0 0 60px rgba(0, 255, 0, 0.8);
/* ... */
```
...
@media (prefers-reduced-motion: reduce) {
  ::-webkit-scrollbar-thumb {
    ...
    box-shadow: 0 0 10px rgba(255, 20, 147, 0.8), 0 0 20px rgba(0, 255, 255, 0.6);
  }
}
```
